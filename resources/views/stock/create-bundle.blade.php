<x-app-layout>
    ...
    <div class="py-6">
        <div class="bg-gray-100 shadow rounded-lg p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-2xl font-semibold text-gray-800">Product Bundle</h3>
            ...
            <form method="POST" action="{{ route('bundles.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            @foreach($products as $product)
                                <div class="product-item flex items-center p-3 border rounded hover:bg-gray-50" 
                                    ...
                                    <input type="checkbox" 
                                        ...
                                        onchange="toggleProduct('{{ $product->_id }}', '{{ $product->name }}', {{ $product->qty }}, '{{ $product->image_url }}')">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" rows="3" 
                                    class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500"
                                    placeholder="Describe this bundle..."></textarea>
                            </div>

                            <!-- Bundle Price -->
                            <div class="mb-4">
                                <label class="block text-sm font-medium mb-2">Bundle Price *</label>
                                <input type="number" step="0.01" name="bundlePrice" required 
                                    class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500"
                                    placeholder="0.00">
                            </div>
                            ...
                            <!-- Bundle Image -->
                            <div class="mb-4">
                                <label class="block text-sm font-medium mb-2">Bundle Image (Optional)</label>
                        ...
                        <!-- Submit Button -->
                        <button type="submit" class="w-full px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-semibold text-lg">
                            Create Bundle
                        </button>
                    </div>
                </div>
    ...
    function toggleProduct(productId, productName, stock, imageUrl) {

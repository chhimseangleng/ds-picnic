                    ...
                    <div
                        ...
                        <div class="mt-3 flex flex-col gap-2">
                            ...
                            <div class="flex gap-2">
                                <!-- View Button -->
                                <button
                                    class="flex-1 px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 flex items-center justify-center"
                                    onclick='openViewProductModal(@json($product))'>
                                    <!-- Icon: Eye -->
                                ...
                                <!-- Add Stock Button -->
                                <button
                                    class="flex-1 px-3 py-1 bg-orange-500 text-white rounded hover:bg-orange-600 flex items-center justify-center"
                            ...
                            <div class="flex gap-2 mt-2">
                                <!-- Edit Button -->
                                <button
                                    class="flex-1 px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 flex items-center justify-center">
                                    <!-- Icon: Pencil -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <!-- Delete Button -->
                                <button
                                    class="flex-1 px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700 flex items-center justify-center">
                                    <!-- Icon: Trash -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
